...
.Mejoras adicionales de IAM
* Compatibilidad para asignar más de un rol a un usuario.
* Ahora, los roles están asociados a una de tres categorías: Plataforma, aplicación y servicios de datos.
* Hay dos nuevos roles asociados a la categoría de aplicación: Visor del almacenamiento y Administrador del almacenamiento.
+
https://docs.netapp.com/us-en/bluexp-setup-admin/reference-iam-predefined-roles.html["Lea acerca de los roles de IAM"]
