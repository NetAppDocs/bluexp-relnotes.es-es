...
==== IMDSv1 requisito para EC2 instancias

Debe tener en cuenta que la instancia Metadata Service versión 1 (IMDSv1) es necesaria en las instancias de Amazon EC2 antes de instalar manualmente el software Connector en AWS.

https://docs.netapp.com/us-en/bluexp-setup-admin/reference-limitations.html["Obtenga más información sobre el requisito para IMDSv1 en AWS"].
