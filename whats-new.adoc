...
=== Gestión de acceso e identidad de BlueXP
...
=== Crear un caso de soporte para servicios BlueXP  adicionales
...
== 7 de octubre de 2024 == página de lista de alertas BlueXP  Puede identificar rápidamente clústeres de ONTAP con poca capacidad o bajo rendimiento, medir el grado de la disponibilidad e identificar los riesgos de seguridad. Es posible ver alertas relacionadas con la capacidad, el rendimiento, la protección, la disponibilidad, la seguridad y la configuración.

=== Detalles de alertas Puede acceder a detalles de alertas y buscar recomendaciones.

=== Ver detalles del clúster vinculados a System Manager con alertas de BlueXP , puede ver las alertas asociadas con el entorno de almacenamiento de ONTAP y profundizar en los detalles que están vinculados a ONTAP System Manager.

https://docs.netapp.com/us-en/bluexp-alerts/concept-alerts.html["Más información sobre las alertas de BlueXP"].

== Amazon FSx para ONTAP

== 02 de febrero de 2025 == Asociar FSX para el sistema de archivos ONTAP con un espacio de trabajo en BlueXP  Después de la integración con BlueXP  En noviembre de 2024, los sistemas de archivos FSX para ONTAP recién creados no estaban asociados con un espacio de trabajo en BlueXP . Ahora, cuando creas o detectas sistemas de archivos FSx for ONTAP, estos se asocian a un espacio de trabajo dentro de una cuenta de BlueXP .
...
Eliminación del sistema de archivos del lienzo de BlueXP  Ahora puede eliminar un sistema de archivos FSX for ONTAP de un espacio de trabajo en el lienzo de BlueXP . Esta operación disocia el sistema de archivos de un espacio de trabajo para que pueda asociarlo a otro espacio de trabajo dentro de la misma cuenta de BlueXP .
...
=== CloudShell disponible en cargas de trabajo BlueXP 
...
== 11 de noviembre de 2024 === FSx para ONTAP se integra con el almacenamiento en la fábrica de cargas de trabajo de BlueXP  FSx para tareas de administración del sistema de archivos ONTAP, como añadir volúmenes, ampliar la capacidad del sistema de archivos y gestionar las máquinas virtuales de almacenamiento, ahora se gestionan en la fábrica de cargas de trabajo de BlueXP , un nuevo servicio ofrecido por NetApp y Amazon FSx para NetApp ONTAP. Puede utilizar sus credenciales y permisos existentes igual que antes. La diferencia es que ahora puede hacer más desde la fábrica de cargas de trabajo de BlueXP  para gestionar sus sistemas de archivos. Cuando abres un entorno de trabajo de FSx para ONTAP desde el Canvas de BlueXP , pasarás directamente a la fábrica de cargas de trabajo de BlueXP .
...
=== Capacidad de añadir nuevos bloques de BlueXP 
...
== 5 Junio 2023 :Icons: Font :imagesdir: ../media/
...
=== Las funciones de red ahora admitidas en BlueXP  al configurar un volumen en Azure NetApp Files desde BlueXP , ahora se pueden indicar las funciones de red. Se alinea con la funcionalidad disponible en la Azure NetApp Files nativa.

== 12 Junio 2024 === Se requiere permiso nuevo
...
== 22 de abril de 2024 === Ya no se admiten plantillas de volúmenes
...
== 22 de noviembre de 2024 Esta versión de copia de seguridad y recuperación de BlueXP  incluye las siguientes actualizaciones.
...
=== Indexación para el proceso de búsqueda y restauración en la página de volúmenes Antes de utilizar Search & Restore, debe activar la indexación en cada entorno de trabajo de origen desde el que desee restaurar datos de volumen. Esto permite que el catálogo indexado realice un seguimiento de los archivos de copia de seguridad de cada volumen. Ahora, la página Volúmenes muestra el estado de indexación:
...
== 27 de septiembre de 2024 Esta versión de copia de seguridad y recuperación de BlueXP  incluye las siguientes actualizaciones.

El soporte de Podman en RHEL 8 o 9 con Examinar y restaurar copia de seguridad y recuperación de BlueXP  ahora admite la restauración de archivos y carpetas en Red Hat Enterprise Linux (RHEL) versiones 8 y 9 con el motor Podman. Esto se aplica al método de exploración y restauración de backup y recuperación de BlueXP .
...
=== Indexación de catálogo más rápida Mejora la búsqueda y la restauración Esta versión incluye un índice de catálogo mejorado que completa la indexación de línea base mucho más rápido. Una indización más rápida permite utilizar la función de búsqueda y restauración más rápidamente.
...
=== La restauración de carpetas o directorios FlexGroup ahora disponible anteriormente, los volúmenes FlexVol se podían restaurar, pero no se podían restaurar carpetas o directorios FlexGroup. Con ONTAP 9.15.1 P2, puede restaurar carpetas de FlexGroup con la opción Examinar y restaurar.
...
== 22 de enero de 2025 === Versión 1,39 Esta versión de clasificación de BlueXP  actualiza el proceso de exportación para el informe de investigación de datos. Esta actualización de exportación es útil para realizar análisis adicionales de sus datos, crear visualizaciones adicionales de los datos o compartir los resultados de su investigación de datos con otros.
...
== 16 de diciembre de 2024 === Versión 1,38 Esta versión de clasificación de BlueXP  incluye mejoras generales y correcciones de errores.

== 4 de noviembre de 2024 === Versión 1,37 Esta versión de clasificación de BlueXP  incluye las siguientes actualizaciones.
...
== 10 de febrero de 2025 === Autenticación de usuario habilitada para acceder a System Manager desde BlueXP  Como administrador de BlueXP , ahora puede activar la autenticación para usuarios de ONTAP que accedan a ONTAP System Manager desde BlueXP . Puede activar esta opción editando la configuración del conector BlueXP . Esta opción está disponible para los modos estándar y privado.
...
BlueXP  Vista avanzada renombrada a Administrador del sistema La opción para la administración avanzada de Cloud Volumes ONTAP desde BlueXP  a través del Administrador del sistema de ONTAP ha cambiado de *Vista avanzada* a *Administrador del sistema*.

link:https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-administer-advanced-view.html["Administrar Cloud Volumes ONTAP mediante System Manager"^].

Introducción de una forma más sencilla de gestionar las licencias con la cartera digital de BlueXP  Ahora, puede experimentar una gestión simplificada de las licencias de Cloud Volumes ONTAP mediante el uso de puntos de navegación mejorados dentro de la cartera digital de BlueXP :
...
== 11 de noviembre de 2024 == Fin de disponibilidad para licencias basadas en nodos
...
=== Eliminación de las puestas en marcha basadas en nodos de BlueXP  La opción de implementar sistemas Cloud Volumes ONTAP mediante licencias basadas en nodos está obsoleta en BlueXP . Excepto para algunos casos especiales, no se pueden utilizar licencias basadas en nodos para implementaciones de Cloud Volumes ONTAP para ningún proveedor de cloud.
...
=== Agregación de un nivel frío para los datos de Cloud Volumes ONTAP en el almacenamiento de Azure Blob
...
=== Opción de restringir el acceso público a la cuenta de almacenamiento para Azure Ahora tiene la opción de restringir el acceso público a su cuenta de almacenamiento para sistemas Cloud Volumes ONTAP en Azure. Al deshabilitar el acceso, puede proteger su dirección IP privada de la exposición incluso dentro de la misma red virtual, en caso de que sea necesario cumplir con las políticas de seguridad de su organización. Esta opción también deshabilita la organización de datos en niveles de los sistemas Cloud Volumes ONTAP y se aplica a pares de nodo único y de alta disponibilidad.
...
=== Soporte de Cloud Volumes Service para Google Cloud
...
== Operaciones del cloud

== 7 de diciembre de 2020 === Navegación entre Cloud Manager y Spot
...
== 18 de octubre de 2020 === Introducción al servicio Compute
...
== 2 de febrero de 2025 === Nuevo soporte de SO para data broker El broker de datos ahora es compatible con hosts que ejecutan Red Hat Enterprise 9,4, Ubuntu 23,04 y Ubuntu 24,04.
...
== 27 de octubre de 2024 === Corrección de errores
...
== 16 de septiembre de 2024 === Correcciones de errores Actualizamos el servicio de copia y sincronización de BlueXP  y el agente de datos para corregir algunos errores. La nueva versión de Data Broker es 1,0.55.

== Asesor digital

== 12 de diciembre de 2024

=== Asesor de actualizaciones Ahora puede ver el firmware de almacenamiento, el firmware del SP/BMC y el paquete autónomo de ransomware (ARP) que se recomiendan para una actualización. link:https://docs.netapp.com/us-en/active-iq/view-firmware-update-recommendations.html["Aprenda a ver las recomendaciones de actualización de firmware"].

== 04 de diciembre de 2024

Widget AutoSupport El widget AutoSupport se ha agregado a la pantalla principal del panel de control para alertar a los clientes sobre los problemas relacionados con el estado de AutoSupport.

== 23 de septiembre de 2024

La oferta de servicios de NetApp SupportEdge Basic ahora incluye todas las características del asesor digital disponibles en SupportEdge Advisor y SupportEdge Expert, excepto para la topología de pila completa (VMware), que no proporciona visibilidad en la supervisión de pila completa de VMware, incluso si está activada.
...
Nueva consola de descripción general La página de inicio de la cartera digital tiene un panel actualizado de sus licencias de NetApp y suscripciones de Marketplace, con la capacidad de profundizar en servicios específicos, tipos de licencia y acciones requeridas.

=== Configuración de suscripciones a credenciales La cartera digital de BlueXP  ahora le permite configurar sus suscripciones con las credenciales del proveedor. Normalmente, lo haces cuando te suscribes por primera vez a una suscripción del Marketplace o un contrato anual. El cambio anterior de las credenciales de la suscripción sólo se podía realizar en la página Credenciales.

Asociación de suscripciones a organizaciones Ahora puede actualizar la organización a la que está asociada una suscripción directamente desde la cartera digital.

Administración de licencias de Cloud Volume ONTAP Ahora administra licencias de Cloud Volumes ONTAP a través de la página de inicio o la pestaña *Licencias de servicio de datos*. Utilice la pestaña *Suscripciones de Marketplace* para ver la información de su suscripción.
...
== 30 de octubre de 2024 === Informes Ahora puede generar y descargar informes para ayudarle a analizar su paisaje. Los informes prediseñados resumen las recuperaciones tras fallos y las recuperaciones tras fallos, muestran los detalles de la replicación en todos los sitios y muestran los detalles del trabajo de los últimos siete días.
...
==== Prueba gratuita de 30 días Ahora puedes registrarte para una prueba gratuita de 30 días de recuperación ante desastres de BlueXP . Anteriormente, las pruebas gratuitas eran de 90 días.

Consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/get-started/dr-licensing.html["Configurar la licencia"].

=== Desactivar y activar los planes de replicación Una versión anterior incluía actualizaciones de la estructura de programación de la prueba de conmutación por error, que era necesaria para admitir programas diarios y semanales. Esta actualización requería deshabilitar y volver a activar todos los planes de replicación existentes para poder utilizar los nuevos programas de prueba de conmutación por error diarios y semanales. Este es un requisito único.
...
=== Asignación de carpetas Al crear un plan de replicación y asignar recursos de computación, ahora puede asignar carpetas para que las máquinas virtuales se recuperen en una carpeta especificada para el centro de datos, el clúster y el host.
...
=== Detalles de equipos virtuales disponibles para conmutación por error, conmutación por error y conmutación por error de prueba cuando se produce un fallo y se inicia una conmutación por error, realiza una conmutación de retorno tras recuperación o prueba de la conmutación por error, ahora puede ver los detalles de los equipos virtuales e identificar qué equipos virtuales no se reiniciaron.
...
=== Retraso de inicio de VM Con una secuencia de inicio ordenada Cuando crea un plan de replicación, ahora puede establecer un retraso de inicio para cada VM del plan. De este modo, es posible establecer una secuencia para que las máquinas virtuales se inicien para garantizar que se ejecute toda la prioridad que se tienen unas máquinas virtuales antes de que se inicien las siguientes de prioridad.

Para obtener más información, consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/drplan-create.html["Cree un plan de replicación"] .

=== Información del sistema operativo de VM Cuando crea un plan de replicación, ahora puede ver el sistema operativo de cada VM en el plan. Esto es útil para decidir cómo agrupar máquinas virtuales en un grupo de recursos.

Para obtener más información, consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/drplan-create.html["Cree un plan de replicación"] .

=== alias de nombres de VM Cuando crea un plan de replicación, ahora puede agregar un prefijo y sufijo a los nombres de VM en el área de recuperación ante desastres. Esto permite usar un nombre más descriptivo para las máquinas virtuales del plan.

Para obtener más información, consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/drplan-create.html["Cree un plan de replicación"] .

=== Limpiar copias de Snapshot antiguas Puede eliminar las copias de Snapshot que ya no sean necesarias más allá del recuento de retención especificado. Las copias Snapshot pueden acumularse con el tiempo al reducir el número de retención de snapshots y ahora puede quitarlas para liberar espacio. Puede hacerlo en cualquier momento bajo demanda o cuando elimine un plan de replicación.
...
=== Compatibilidad con almacenes de datos VMFS de VMware en las instalaciones Esta versión incluye compatibilidad con las VM montadas en almacenes de datos de sistema de archivos para máquinas virtuales (VMFS) de VMware vSphere para iSCSI y FC protegido al almacenamiento en las instalaciones. Anteriormente, el servicio ofrecía una _technology preview_ que admitía los almacenes de datos VMFS para iSCSI y FC.
...
=== Compatibilidad con almacenes de datos VMFS de VMware para FC en las instalaciones Esta versión incluye una vista previa _TECHNOLOGY_ de soporte para VM montadas en almacenes de datos del sistema de archivos de máquinas virtuales (VMFS) de VMware vSphere para FC protegido en el almacenamiento local. Anteriormente, el servicio ofrecía una vista previa de la tecnología que admitía almacenes de datos VMFS para iSCSI.


NOTE: NetApp no le cobra por ninguna capacidad de carga de trabajo vista previa.

=== Cancelación del trabajo Con esta versión, ahora puede cancelar un trabajo en la interfaz de usuario de Job Monitor.
...
=== Compatibilidad con E-Series Ahora puede detectar sus sistemas E-Series directamente desde BlueXP . El descubrimiento de sistemas E-Series le ofrece una visión completa de los datos en su multicloud híbrido.

== Eficiencia económica

== 15 de mayo de 2024

=== Funciones desactivadas Algunas funciones de eficiencia económica de BlueXP  se han desactivado temporalmente:
...
=== Actualización tecnológica Esta versión de eficiencia económica de BlueXP  incluye una nueva opción para realizar una evaluación de sus activos e identificar si se recomienda una actualización tecnológica. El servicio incluye una nueva opción de actualización tecnológica en la navegación izquierda, nuevas páginas en las que puede realizar una evaluación de sus activos y cargas de trabajo actuales, y un informe que le ofrece recomendaciones.
...
Capacidad de agregar nuevos buckets y administrar los buckets existentes desde BlueXP  Usted ha tenido la capacidad de ver los buckets de Google Cloud Storage en el lienzo de BlueXP  durante bastante tiempo. Ahora puede agregar nuevos cubos y cambiar las propiedades de los cubos existentes directamente desde BlueXP . https://docs.netapp.com/us-en/bluexp-google-cloud-storage/task-add-gcp-bucket.html["Descubre cómo añadir nuevos buckets de Google Cloud Storage"].
...
=== Soporte para sistemas ASA R2 con modo privado
...
=== Las plantillas de volumen ya no se admiten. Ya no se puede crear un volumen a partir de una plantilla. Esta acción se asoció con el servicio de corrección de BlueXP, que ya no está disponible.

== Resistencia operativa

== 02 de abril de 2023

=== El servicio de resiliencia operativa de BlueXP  mediante el nuevo servicio de resiliencia operativa de BlueXP  y sus sugerencias automatizadas de corrección de riesgos operativos de TI, puede implementar soluciones sugeridas antes de que se produzca una interrupción o un fallo.
...
=== Detecta comportamientos anómalos de usuarios con la seguridad de las cargas de trabajo de almacenamiento de Data Infrastructure Insights
...
Integración de SIEM con Microsoft Sentinel Ahora puede enviar datos a su sistema de gestión de eventos y seguridad (SIEM) para el análisis y la detección de amenazas mediante Microsoft Sentinel. Anteriormente, podía seleccionar AWS Security Hub o Splunk Cloud como su SIEM.
...
== 30 de septiembre de 2024 === Agrupación personalizada de cargas de trabajo de recursos compartidos de archivos Con esta versión, ahora puede agrupar recursos compartidos de archivos en grupos para facilitar la protección de los datos. El servicio puede proteger todos los volúmenes de un grupo a la vez. Anteriormente, era necesario proteger cada volumen por separado.
...
=== FSx para ONTAP a Cloud Volumes ONTAP Ahora puedes replicar datos desde un sistema de archivos Amazon FSx para ONTAP a Cloud Volumes ONTAP.

https://docs.netapp.com/us-en/bluexp-replication/task-replicating-data.html["Aprenda a configurar la replicación de datos"].

== 31 de julio de 2022

=== FSX for ONTAP como origen de datos que ahora puede replicar datos de un sistema de archivos de Amazon FSx para ONTAP en los destinos siguientes:
...
=== Soporte para Amazon FSx para ONTAP Ahora puedes replicar datos de un sistema Cloud Volumes ONTAP o un clúster de ONTAP on-premises en un sistema de archivos de Amazon FSx para ONTAP.
...
Actualización de ONTAP El servicio de actualizaciones de software de BlueXP  proporciona una experiencia de actualización fluida a los usuarios, ya que mitiga los riesgos y garantiza que los clientes puedan aprovechar al máximo las funciones de ONTAP.
...
=== Nueva vista avanzada que empieza con StorageGRID 11,8, puede usar la conocida interfaz de Grid Manager para gestionar su sistema StorageGRID desde BlueXP .
...
Capacidad de revisar y aprobar el certificado de interfaz de gestión de StorageGRID Ahora tiene la capacidad de revisar y aprobar un certificado de interfaz de gestión de StorageGRID al detectar el sistema StorageGRID de BlueXP . También se puede revisar y aprobar el último certificado de interfaz de gestión de StorageGRID en una cuadrícula detectada.
...
=== Soporte para StorageGRID Ahora puede detectar sus sistemas StorageGRID directamente desde BlueXP . El descubrimiento de StorageGRID le ofrece una visión completa de los datos en su multicloud híbrido.

== Organización en niveles

== 9 de agosto de 2023

=== Utilice un prefijo personalizado para el nombre del depósito en el pasado que necesite para utilizar el prefijo predeterminado «fabric-pool» al definir el nombre del depósito, por ejemplo, _fabric-pool-bucket1_. Ahora puede utilizar un prefijo personalizado al asignar un nombre a su cubo. Esta funcionalidad solo está disponible cuando se organizan los datos en niveles en Amazon S3. https://docs.netapp.com/us-en/bluexp-tiering/task-tiering-onprem-aws.html#prepare-your-aws-environment["Leer más"].

=== Buscar un clúster en todos los conectores BlueXP  Si utiliza varios conectores para gestionar todos los sistemas de almacenamiento del entorno, algunos clústeres en los que desea implementar la organización en niveles pueden estar en conectores diferentes. Si no está seguro de qué conector gestiona un determinado cluster, puede buscar en todos los conectores mediante la organización en niveles de BlueXP . https://docs.netapp.com/us-en/bluexp-tiering/task-managing-tiering.html#search-for-a-cluster-across-all-bluexp-connectors["Leer más"].

== 4 de julio de 2023

=== Ajustar el ancho de banda para transferir datos inactivos al activar la organización en niveles BlueXP , ONTAP puede usar una cantidad ilimitada de ancho de banda de red para transferir los datos inactivos desde los volúmenes del clúster al almacenamiento de objetos. Si observa que el tráfico por niveles afecta a las cargas de trabajo normales de usuario, puede limitar la cantidad de ancho de banda que se puede utilizar durante la transferencia. https://docs.netapp.com/us-en/bluexp-tiering/task-managing-tiering.html#changing-the-network-bandwidth-available-to-upload-inactive-data-to-object-storage["Leer más"].

=== Evento de organización en niveles que se muestra en el centro de notificación El evento de organización en niveles «Organizar datos adicionales del clúster <name> al almacenamiento de objetos para aumentar la eficiencia del almacenamiento» ahora aparece como una notificación cuando un clúster organiza en niveles menos del 20 % de sus datos inactivos, incluidos los clústeres que no organizan datos en niveles.
...
CloudShell disponible en la consola de fábrica de cargas de trabajo de BlueXP  CloudShell está disponible desde cualquier lugar de la consola de fábrica de cargas de trabajo de BlueXP . CloudShell le permite usar las credenciales de AWS y ONTAP que ha proporcionado en su cuenta de BlueXP  y ejecutar comandos de la CLI de AWS o comandos de la CLI de ONTAP en un entorno similar al shell.

link:https://docs.netapp.com/us-en/workload-setup-admin/use-cloudshell.html["Usar CloudShell"]

=== Actualización de permisos para bases de datos El siguiente permiso está ahora disponible en el modo _READ_ para bases de datos `iam:SimulatePrincipalPolicy`: .
...
=== El soporte para cuentas de servicio en la fábrica de cargas de trabajo de BlueXP  Las cuentas de servicio ahora se admiten en la fábrica de cargas de trabajo de BlueXP . Puede crear cuentas de servicio para actuar como usuarios de máquinas que automatizan las operaciones de infraestructura.
