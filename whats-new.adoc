...
BlueXP ahora ofrece una interfaz más intuitiva para administrar la federación de identidad cuando se utiliza el modo estándar. Esto incluye una navegación más sencilla, opciones más claras para configurar conexiones federadas y una mejor visibilidad de las federaciones existentes.
...
+
Para más detalles, consulte https://docs.netapp.com/us-en/bluexp-backup-recovery/br-start-licensing.html["Configurar la licencia para la BlueXP backup and recovery"] .
...
==== Configuración de script para conmutación por error de prueba

Con esta versión, ahora puedes ejecutar scripts en las máquinas virtuales después de que se encienden durante el proceso de conmutación por error de prueba. Esto le permite probar y validar scripts. Por ejemplo, puede actualizar los montajes NFS para que apunten a un nuevo servidor de destino, lo que garantiza que las aplicaciones invitadas estén completamente en línea y que su proceso de recuperación pueda probarse de extremo a extremo.

Para obtener más información sobre el proceso de conmutación por error, consultelink:https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/failover.html["Conmutar por error las aplicaciones a un sitio remoto"] .



==== Proceso de conmutación por error mejorado

Durante la conmutación por error, el proceso de conmutación por recuperación ahora está deshabilitado hasta que se complete el descubrimiento. Esto garantiza que todas las configuraciones se identifiquen y contabilicen correctamente antes de iniciar una conmutación por error y reduce el riesgo de errores.

Para obtener más información sobre el proceso de conmutación por error, consultelink:https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/failback.html["Revertir aplicaciones a la fuente original"] .
...
==== Actualizaciones de BlueXP disaster recovery
...
+
Para más detalles, véase https://docs.netapp.com/us-en/bluexp-disaster-recovery/get-started/dr-intro.html#licensing["Licencias de BlueXP disaster recovery"] y https://docs.netapp.com/us-en/bluexp-disaster-recovery/get-started/dr-licensing.html["Configurar la licencia para la BlueXP disaster recovery"] .
