...
==== Compatibilidad con instalaciones locales que usen RHEL versión 9

Red Hat Enterprise Linux, las versiones 8 y 9 no son compatibles con el motor Docker, que se requiere para la instalación de la clasificación de BlueXP. Ahora admitimos la instalación en RHEL 9,0, 9,1 y 9,2 con Podman versión 4 o posterior como infraestructura de contenedores. Si tu entorno requiere el uso de las versiones más recientes de RHEL, ahora puedes instalar la clasificación de BlueXP (versión 1,26 o posterior) cuando utilizas Podman.

En este momento, no admitimos instalaciones de sitios oscuros ni entornos de escaneo distribuidos (con nodos de escáner maestro y remoto).



==== Los resultados de la página Investigación ahora muestran el tamaño total además del número total de elementos
