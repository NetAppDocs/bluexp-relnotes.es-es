...
| Conector | 3,9.50, 3.9.49 | GTO al https://docs.netapp.com/us-en/bluexp-setup-admin/whats-new.html#connector-3-9-50["Novedades en la página de conectores de BlueXP"] y consulte los cambios incluidos para las versiones 3.9.50 y 3,9.49. 
...
Directiva no resuelta en <stdin> - Include::https://raw.githubusercontent.com/NetAppDocs/bluexp-cloud-ops/main/whats-new.adoc[tag=whats-new,leveloffset=+1]
